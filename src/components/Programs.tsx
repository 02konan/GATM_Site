...
const Programs: React.FC = () => {
  ...
  const programs = [
    {
      title: 'Formation et Développement de Compétences',
      duration: '2 mois',
      certificate: 'Certification',
      description:"Formations professionnelles courtes,Ateliers pratiques,E-learning et formations hybrides",
      features: ['Leadership training', 'Thèse professionnelle', 'Réseau alumni'],

    },
    {
      title: ' Alternance et Stages',
      duration: '6 mois',
      certificate: 'Certification',
      description: 'Mise en relation étudiants / entreprises pour des contrats d’alternance,Organisation de stages pratiques pour les jeunes diplômés',
    ...
    },
    {
      ...
      duration: '1 an',
      certificate: 'Certification',
      description: 'Coaching en orientation professionnelle (pour étudiants et jeunes diplômés),Bilan de compétences pour adultes en reconversion',
      features: ['Aide à la rédaction ', 'Programmes de mentorat', 'Certification rapide'],
    },
    { title: 'Innovation et Projets Spéciaux',
      duration: '4 mois', 
      certificate: 'Certification', 
      description: 'Incubation et accompagnement de porteurs de projets (entrepreneuriat jeune),Promotion des métiers d’avenir (digital, IA, énergies renouvelables, etc.)',
      features: [ 'Ateliers de créativité', 'Projets en équipe', 'Accès à un réseau d\'experts', ],
    },
    { title: 'Recrutement et Mise à Disposition de Talents',
      duration: '5 mois', 
      certificate: 'Certification', 
      description: 'Service de recrutement pour les entreprises partenaires,Mise à disposition de jeunes talents formés selon les besoins des entreprises', 
      features: [ 'Job dating', 'forums de l’emploi', 'Partenariats avec entreprises locales', ], 
    },
    { 
